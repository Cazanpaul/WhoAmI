...
Once you have edited your function you can use the following command lines to build, test and deploy your function to AWS Lambda from the command line (these examples assume the project name is *Rekognize*):
...
Execute unit tests
```
    cd "Rekognize/test/Rekognize.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Rekognize/src/Rekognize"
